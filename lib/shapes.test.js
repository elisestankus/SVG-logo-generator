...
describe('Square', () => {
    test('it should return the svg text for the square class with the color and the text', () => {
        const square = new Square('red', 'ZZZ');

        expect(square.render()).toEqual(`<rect x="55" y="10" width="190" height="190" fill="red" stroke-width="5"/>
        <text x="150" y="105" font-family="Cambria" font-size="70" text-anchor="middle" dominant-baseline="middle" fill="white">ZZZ</text>`)
    })
})